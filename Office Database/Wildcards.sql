...
-- WILDCARDS
--  Wildcards are a way to define PATTERNS that was want to match specific pieces of data to.
...
-- 4 underscores will match ANY 4 characters. ^
...
-- Find a list of all money spent(pay employee) or earned(from total sales) by the company.
