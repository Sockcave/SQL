...
-- JOIN EXAMPLES ON COMPANY DATABASE

-- Find all braches and the names of their managers.
SELECT Employee.emp_id, Employee.first_name, branch.branch_name FROM Employee 
JOIN branch 
ON Employee.emp_id = branch.mgr_id;

-- Get all of the employees and all their IDs even if they are not the managers.
SELECT Employee.emp_id, Employee.first_name, branch.branch_name FROM Employee 
LEFT JOIN branch 
ON Employee.emp_id = branch.mgr_id;

-- Get all of the branches and their managers even if they don't have one.
SELECT Employee.emp_id, Employee.first_name, branch.branch_name FROM Employee 
RIGHT JOIN branch 
ON Employee.emp_id = branch.mgr_id;
